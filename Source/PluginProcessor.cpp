...
bool
PlugintestAudioProcessor::acceptsMidi() const {
...
bool
PlugintestAudioProcessor::producesMidi() const {
...
bool
PlugintestAudioProcessor::isMidiEffect() const {
#if JucePlugin_IsMidiEffect
    return true;
#else
    return false;
...
double
PlugintestAudioProcessor::getTailLengthSeconds() const {
    return 0.0;
}

int
PlugintestAudioProcessor::getNumPrograms() {
...
int
PlugintestAudioProcessor::getCurrentProgram() {
    return 0;
}

void
PlugintestAudioProcessor::setCurrentProgram(int index) {}

const juce::String
PlugintestAudioProcessor::getProgramName(int index) {
    return {};
}

void
PlugintestAudioProcessor::changeProgramName(int index,
                                            const juce::String& newName) {}

void
PlugintestAudioProcessor::prepareToPlay(double sampleRate,
                                        int samplesPerBlock) {
...
void
PlugintestAudioProcessor::releaseResources() {
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool
PlugintestAudioProcessor::isBusesLayoutSupported(
...
void
PlugintestAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
...
bool
PlugintestAudioProcessor::hasEditor() const {
...
void
PlugintestAudioProcessor::getStateInformation(juce::MemoryBlock& destData) {
...
void
PlugintestAudioProcessor::setStateInformation(const void* data,
                                              int sizeInBytes) {
